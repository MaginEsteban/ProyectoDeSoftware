...
<body
    style="background-image: url(<?= base_url('recursos')?>/img/tabla-madera-sobremesa-vacia-fondo-borroso_1253-1584.jpg);">
    <div class="page-wrap d-flex flex-row align-items-center">
        <div class="container">
            <div class="row h-100 justify-content-center align-items-center" style="padding-top: 100px;">

                <div class="col-12 col-sm-8 col-md-6 mx-auto card">
                    ...
                    <form action="<?=base_url('user/check_password'); ?>" class="mt-3" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nro_legajo" class="form-control"
                                placeholder="Ingrese el legajo...">
                        </div>

                        <div class="form-group">
                            <label for="input_email">Email</label>
                            <input id="input_email" class="form-control" type="email" placeholder="Ingresa tu email..."
                                name="email" />
                            <small id="emailHelp" class="form-text text-muted">
                                El email ingresado lo utilizaremos para
                                validar la cuenta...
                            </small>
                        </div>
                        ...
                        <div class="text-center my-3">
                            <a class="btn btn-secondary" href="<?= base_url('dashboard') ?>" role="button">Volver</a>
